...
class Anymarket_ApiExtension_Block_Adminhtml_Anymarketfeed_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		{
				if( Mage::registry("anymarketfeed_data") && Mage::registry("anymarketfeed_data")->getId() ){

				    return Mage::helper("apiextension")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("anymarketfeed_data")->getId()));
