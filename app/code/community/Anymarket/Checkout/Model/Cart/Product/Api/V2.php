<?php
/**
 * Anymarket Checkout api extension
 * Overrides of shopping cart api for product
 * 
 * This class add the option to handle shopping carts from Anymarket
 * thanks to Sebastian Schneider
 *
 * @category   Anymarket
 * @package    Anymarket_Catalog
 */
class Anymarket_Checkout_Model_Cart_Product_Api_V2 extends Mage_Checkout_Model_Cart_Product_Api_V2
{
